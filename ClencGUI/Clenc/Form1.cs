...
namespace Clenc
{
    public partial class Form1 : Form
    {
        ...
        public BigInteger bajty = 8388602;
        public int enctimer;
        ...
        public void GenerowanieCMD()
        {
            ...
            string cmdtext = "ffmpeg -y -hide_banner " + nvaccel + " -ss " + poczatek + " -i " + '"' + plikzrodlowy + '"' + " -c:v " + kodekwideo + " -cpu-used " + encspdtrack.Value + arnrplus + " -row-mt 1 -g 255 -pix_fmt yuv420p -tile-rows 0 -tile-columns 0 " + cputhreads + " -lag-in-frames " + laginframesnum + " -auto-alt-ref " + altrefenabled + " " + fpschange + " -an -map 0:v:0 " + usersettingstext + "-b:v " + bitratewideo + "k -t " + sekundywideo + " " + videodimensions + " -f webm -passlogfile CLENCguilog -pass ";
            liniakomend.Text =  cmdtext + "1 .\\tempdir\\videop1.webm";
            liniakomend2.Text = cmdtext + "2 .\\tempdir\\videop2.webm";
            liniakomendaudio.Text = "ffmpeg -y -ss " + poczatek + " -i " + '"' + plikzrodlowy + '"' + " " + mapowanieaudio + " -vn " + voipoptimizationcmd + audiofade + "-t " + sekundywideo + " -c:a libopus -frame_duration 120 -ac " + kanalyaudio + " -b:a ";
        }
        ...
        private void obliczanieB()
        {
            if (BigInteger.TryParse(wielkosciplikubox.Text, out _))
            {
                ...
                bajty = oczekiwanawielkoscpliku * 128 - 6;
                ObliczanieBitrateDiscord();
            }
            else
            {
